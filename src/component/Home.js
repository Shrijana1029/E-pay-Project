...
<section className="pt-24 bg-white">
    <div className="px-12 mx-auto max-w-7xl">
        ...
        {/* <div className="w-full mx-auto text-left md:w-11/12 xl:w-9/12 md:text-center">
            <h1 className="mb-8 text-4xl font-extrabold leading-none tracking-normal text-gray-900 md:text-6xl md:tracking-tight">
                <span>Start</span> <span className="block w-full py-2 text-transparent bg-clip-text leading-12 bg-gradient-to-r from-green-400 to-purple-500 lg:inline">React Routing</span> <span>for your project</span>
            </h1>
  ...
  <button className="carousel-control-next" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="next">
    ...
    <span className="visually-hidden">Next</span>
        ...
        <h1 class="text-2xl font-semibold text-center text-gray-800 capitalize lg:text-2xl ">How <br /> E-pay  <span class="text-teal-500">  Works??</span></h1>
        ...
        <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-2 xl:grid-cols-3">
            <div class="flex flex-col items-center p-6 space-y-3 text-center bg-tblack rounded-xl dark:bg-teal-500">
                ...
                <a href="#" class="flex items-center -mx-1 text-sm text-black capitalize transition-colors duration-300 transform dark:text-blue-400 hover:underline hover:text-blue-600 dark:hover:text-blue-500">
                    <Link to="/login" class="mx-1">read more</Link>
